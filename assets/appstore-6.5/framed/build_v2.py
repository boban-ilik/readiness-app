...
FRAMES = [
 ("IMG_0285.PNG", "#F5A623", "READINESS COACH", "Your daily<br><b>readiness score</b>", "Built from your HRV, sleep and resting heart rate",
  None, "", "Works with<br><span>the watch</span><br>you already own"),
 ("IMG_0289.PNG", "#A78BFA", "AI COACH", "An <b>AI coach</b> that<br>knows your numbers", "Ask why. Get an answer built on your own data.",
  '<div class="q">Why is my score low today?</div>', "left:40px;top:1010px;transform:rotate(-4deg)", None),
 ("IMG_0286.PNG", "#7CB342", "SCORE BREAKDOWN", "<b>Recovery, sleep</b><br>and <b>stress</b> explained", "See exactly what moved today's score",
  '<div class="k">OPEN FORMULA</div><div class="v">45 · 40 · 15</div><div class="s">recovery · sleep · stress</div>', "right:36px;top:1560px;transform:rotate(4deg)", None),
 ("IMG_0290.PNG", "#60A5FA", "HISTORY &amp; TRENDS", "Track your <b>HRV</b> and<br><b>recovery</b> trends", "7 and 28 day history, with CSV export",
  '<div class="k">ZOOM OUT</div><div class="v">28 days</div><div class="s">plus CSV export</div>', "right:36px;top:1240px;transform:rotate(4deg)", None),
 ("IMG_0291.PNG", "#FBBF24", "PERSONAL PATTERNS", "Find the <b>patterns</b><br>behind your good days", "Insights from your data, not generic advice",
  '<div class="k">YOUR DATA SAYS</div><div class="v">+10 pts</div><div class="s">on nights of 7h+ sleep</div>', "left:36px;top:1330px;transform:rotate(-4deg)", None),
 ("IMG_0287.PNG", "#34D399", "DAILY NUTRITION", "<b>Nutrition</b> matched<br>to your recovery", "Hydration and protein scaled to your body",
...
.badge{position:absolute;right:56px;top:2120px;width:400px;height:400px;border-radius:50%;background:#F5A623;color:#0D0F14;
...
for i,(f,acc,eye,h,sub,chip,pos,badge) in enumerate(FRAMES,1):
    html = (TEMPLATE.replace("__ACCENT__",acc).replace("__EYEBROW__",eye).replace("__H1__",h).replace("__SUB__",sub).replace("__FILE__",f)
